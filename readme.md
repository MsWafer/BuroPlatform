...
Дефолтные значения: если _{value}_ не введен или такого поля нет - _likes_, если _{валуев}_ не введен или не равен _1_ или _-1_ - _-1_. Возвращает массив с отсортированными объектами.
